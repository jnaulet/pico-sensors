...
#define HT16K33_CC_DIMMING_SET   0xe0

/* display data address pointer */
#define HT16K33_A_M  0xf
...
/* dimming set */
#define HT16K33_P_M  0xf
#define HT16K33_P(x) ((x) & HT16K33_P_M)

int ht16k33_write(struct ht16k33 *ctx, int cc, /*@null@*/ const void *buf, size_t n);
